...
import {NO_PERMISSIONS_REQUIRED, getPermissionStatus, updatePermission, showNotification, getPosition} from './common'

export let openPrompt = null
let promptMutex = new Mutex()
export let releasePromptMutex = () => {}
...
export async function handleContentScriptMessage({type, params, host}) {
...
export async function handlePromptMessage({host, type, accept, conditions}, sender) {
    // return response

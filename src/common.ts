...
export async function getPermissionStatus(
	...
	const policies = ((await getStorage('policies')) || {}) as Policies
...
export async function showNotification(
	...
	const message = `${host} was ${allowed ? 'allowed' : 'denied'} to ${PERMISSION_NAMES[type] || type
		}.`
